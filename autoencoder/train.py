...
if __name__ == '__main__':
    ...
    logdir = f'../ckpts/{args.dataset_name}'
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        if epoch > 95:
            ...
            if eval_loss < best_eval_loss:
                ...
                best_epoch = epoch
                torch.save(model.state_dict(), f'../ckpts/{args.dataset_name}/best_ckpt.pth')
                
            if epoch % 10 == 0:
                torch.save(model.state_dict(), f'../ckpts/{args.dataset_name}/{epoch}_ckpt.pth')
